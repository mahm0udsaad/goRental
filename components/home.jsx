  ...
  return (
    <div className="flex xl:max-w-5/6 mx-auto  flex-col items-center overflow-x-hidden">
      ...
      <div className="self-stretch flex w-full flex-col items-stretch max-md:max-w-full">
              ...
              <div className="flex flex-col items-stretch sm:w-[48%]">
                <div className="flex flex-col my-auto max-md:max-w-full max-md:mt-10">
                  ...
                  <div className="text-zinc-700 text-base leading-7 self-stretch mt-6 max-md:max-w-full">
                    Navigate your car rental business with precision and ease.
                    Our management system ensures you never miss a task, from
                    reservations to tracking. Drive efficiency and success with
        ...
        <div className="text-gradient text-zinc-900 text-center text-4xl font-bold leading-10 bg-clip-text max-w-[566px] mt-20 max-md:max-w-full max-md:mt-10">
            <span className="text-zinc-900">Powerful features for</span> powerful
            creators
        </div>
        <div className="text-zinc-900 text-center text-xl leading-7 whitespace-nowrap mt-4">
            Choose a plan that’s right for you
        </div>
        <div className="flex w-[373px] max-w-full gap-2.5 ml-14 mt-14 mb-20 max-md:my-10">
